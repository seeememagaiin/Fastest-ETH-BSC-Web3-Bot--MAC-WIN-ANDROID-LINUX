import argparse, style, getpip, math, sys, json, requests
...
class SniperBot():
    ...
    def parseArgs(self):
        ...
        if self.token == None:
            print(style.RED+"Please Check your Token argument e.g. -t 0x34faa80fec0233e045ed4737cc152a71e490e2e3 -a 0.001 -tx 2 -hp  -wb 10 -tp 50")
            print("exit!")
            sys.exit()
    ...
    def StartUP(self):
        ...
        print(style().GREEN + "[DONE]BSC SNIPER FINISH!" + style().RESET)
